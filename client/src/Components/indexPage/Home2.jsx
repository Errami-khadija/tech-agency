        ...
        <div className='flex flex-col hero'>
            ...
            <div className=" flex flex-row justify-between items-center py-4 w-full ">
                ...
                <div>
                    <ul className="flex flex-row">
                        <li><a className='mx-3 text-base font-medium ' ><Link to="http://localhost:5173/services">Services</Link></a></li>
                        <li><a className='mx-3 text-base font-medium ' ><Link to="http://localhost:5173/about">About</Link></a></li>
                        <li><a className='mx-3 text-base font-medium ' ><Link to="http://localhost:5173/contact">Contact</Link></a></li>
                    </ul>
                </div>
                <Link className='px-4 py-3 rounded-2xl mx-4 bg-blue-500 text-white font-medium text-sm cursor-pointer' to="http://localhost:5173/signup">Get Started</Link>
            </div>
            <div className="  hero  h-full w-full relative flex flex-1 flex-row py-6 items-center justify-center">
                ...
                <div className='hero-shapes shape1' />
                    ...
                    <Link className='px-4 py-3 rounded-2xl bg-blue-500 text-white font-medium text-sm cursor-pointer' to="http://localhost:5173/signup">Get Started</Link>
